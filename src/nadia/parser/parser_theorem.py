...
class ParserTheorem:
    ...
    def toString(premisses, conclusion, parentheses=False):
        if premisses == []:
            ...
            return (
                ", ".join(f.toString(parentheses=parentheses) for f in premisses)
                + " |- "
                + conclusion.toString(parentheses=parentheses)
            )
    ...
    def toLatex(premisses, conclusion, parentheses=False):
        if premisses == []:
            ...
            return (
                ", ".join(f.toLatex(parentheses=parentheses) for f in premisses)
                + " \\vdash "
                + conclusion.toLatex(parentheses=parentheses)
            )
