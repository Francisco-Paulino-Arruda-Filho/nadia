from ParserFactory import BaseParser
...
from nadia.nadia_pt_fo import PredicateFormula


class ParserFormula(BaseParser):
    ...
    def get_tokens(self):
        ...
        return ['COMMA', 'OPEN_PAREN', 'CLOSE_PAREN', 'NOT',
